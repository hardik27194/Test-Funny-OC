...
- (void)yZCircularMenuItemTouchesBegan:(YZCircularMenuItem *)item;
- (void)yZCircularMenuItemTouchesEnd:(YZCircularMenuItem *)item;
...
@optional
- (void)yZCircularMenuDidFinishAnimationClose:(YZCircularMenu *)menu;
- (void)yZCircularMenuDidFinishAnimationOpen:(YZCircularMenu *)menu;
