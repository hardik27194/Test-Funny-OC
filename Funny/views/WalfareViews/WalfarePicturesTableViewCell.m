//
//  WalfarePicturesTableViewCell.m
//  Funny
//
...
@interface WalfarePicturesTableViewCell ()
@property (nonatomic, weak) UILabel *creatTimeLabel;
@end

@implementation WalfarePicturesTableViewCell
...
-(void)setModel:(WalfarePictureModel *)model{
    _model = model;
